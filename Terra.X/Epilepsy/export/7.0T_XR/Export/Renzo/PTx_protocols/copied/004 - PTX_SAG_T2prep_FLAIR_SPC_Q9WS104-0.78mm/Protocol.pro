  ...
  <ParamMap.""> 
  {
    ...
    <ParamMap."Properties"> 
    {
      ...
      <ParamMap."Queue"> 
      {
        ...
        <ParamString."ProtocolName">  { "PTX_SAG_T2prep_FLAIR_SPC_Q9WS104-0.78mm"  }
      }
    }
  }
}
...
ulVersion	 = 	66010002
tSequenceFileName	 = 	"%CustomerSeq%\wip_SPACE_997_v01_space_997"
tProtocolName	 = 	"PTX_SAG_T2prep_FLAIR_SPC_Q9WS104-0.78mm"
...
dAveragesDouble	 = 	1.0
lScanTimeSec	 = 	424
lTotalScanTimeSec	 = 	426
dRefSNR	 = 	40177.1802215
dRefSNR_VOI	 = 	37307.3816342
ulMotionCorr	 = 	1
ucCineMode	 = 	1
ucSequenceType	 = 	8
ucCoilCombineMode	 = 	2
...
lSilentPeriod	 = 	0
dOverallImageScaleFactor	 = 	0.00740921629811
...
sTXSPEC.tB1ShimPPDconfigFile	 = 	"PPDconfig_B1shim_space"
...
sAdjData.uiAdjFreConfirmOverrideKey	 = 	710404
...
sSliceArray.asSlice[0].dThickness	 = 	162.24
sSliceArray.asSlice[0].dPhaseFOV	 = 	225.0
sSliceArray.asSlice[0].dReadoutFOV	 = 	225.0
sSliceArray.asSlice[0].dInPlaneRot	 = 	0.182037840983
sSliceArray.asSlice[0].sPosition.dSag	 = 	0.0423640494122
sSliceArray.asSlice[0].sPosition.dCor	 = 	3.89529819252
sSliceArray.asSlice[0].sPosition.dTra	 = 	-29.7528577464
sSliceArray.asSlice[0].sNormal.dSag	 = 	0.999988
sSliceArray.asSlice[0].sNormal.dCor	 = 	0.001103
sSliceArray.asSlice[0].sNormal.dTra	 = 	0.004731
...
sPrepPulses.dGradMomRead	 = 	200.0
sPrepPulses.dGradMomPhase	 = 	200.0
sPrepPulses.dGradMomSlice	 = 	200.0
...
sPrepPulses.adT2PrepDuration[0]	 = 	125.0
sKSpace.dPhaseResolution	 = 	1.0
sKSpace.dSliceResolution	 = 	1.0
sKSpace.dSliceOversamplingForDialog	 = 	0.0769230769231
sKSpace.dAngioDynCentralRegionA	 = 	20.0
sKSpace.dAngioDynSamplingDensityB	 = 	25.0
sKSpace.dSeqPhasePartialFourierForSNR	 = 	0.81875
sKSpace.lBaseResolution	 = 	288
sKSpace.lPhaseEncodingLines	 = 	288
sKSpace.lPartitions	 = 	224
sKSpace.lImagesPerSlab	 = 	208
...
sAAInitialOffset.SliceInformation.dInPlaneRot	 = 	3.49065850399e-05
sAAInitialOffset.SliceInformation.sPosition.dSag	 = 	-5.01720412258e-07
sAAInitialOffset.SliceInformation.sPosition.dCor	 = 	-1.95578680418
sAAInitialOffset.SliceInformation.sPosition.dTra	 = 	-23.3995331387
sAAInitialOffset.SliceInformation.sNormal.dSag	 = 	1.0
sAAInitialOffset.SliceInformation.sNormal.dCor	 = 	1.7394478018e-07
sAAInitialOffset.SliceInformation.sNormal.dTra	 = 	7.03279020949e-07
alRepetitionsDelayTimeMs.__attribute__.size	 = 	64
adFlipAngleDegree.__attribute__.size	 = 	32
adFlipAngleDegree[0]	 = 	120.0
aulServicePara.__attribute__.size	 = 	5
aulServicePara[1]	 = 	420
...
sWipMemBlock.tFree	 = 	"base64:eyJNb2RlbC5JRCI6NzI1fQ=="
...
sCommonIterRecon.lDenoisingStrength	 = 	6
