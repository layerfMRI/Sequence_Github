  ...
  <ParamMap.""> 
  {
    ...
    <ParamMap."Properties"> 
    {
      ...
      <ParamMap."Queue"> 
      {
        ...
        <ParamString."ProtocolName">  { "PTX_SAG_DIR_FLAIR_SPC_Q9WS104-0.78mm"  }
      }
    }
  }
}
...
tProtocolName	 = 	"PTX_SAG_DIR_FLAIR_SPC_Q9WS104-0.78mm"
...
sSliceArray.asSlice[0].sPosition.dSag	 = 	0.0304729386125
sSliceArray.asSlice[0].sPosition.dCor	 = 	-9.10291273651
sSliceArray.asSlice[0].sPosition.dTra	 = 	-24.2090634634
...
sAAInitialOffset.SliceInformation.sPosition.dSag	 = 	-5.87419065182e-07
sAAInitialOffset.SliceInformation.sPosition.dCor	 = 	-15.7427366881
sAAInitialOffset.SliceInformation.sPosition.dTra	 = 	-20.2999691848
